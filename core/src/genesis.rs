...
pub fn genesis_main() -> core::Block {
	let gen = core::Block::with_header(core::BlockHeader {
		...
		prev_root: Hash::from_hex("00000000000000000002045d9a7a4fb039d468fb751e094efe10e6b0199711ac").unwrap(), // REPLACE
		output_root: Hash::from_hex("4ddd2e2e848d191fab24581420c958426fbc1a5f5c30931c63bdf3f508a42f3b").unwrap(), // REPLACE
		range_proof_root: Hash::from_hex("126de35affdd727d1230103e05dd97ed4a1525ffef31ac0f47f58588002a505a").unwrap(), // REPLACE
		kernel_root: Hash::from_hex("88588ffb085edf3c779dd1326c4f36e3cfd9d2ce5f4753a98c8206a63f875c56").unwrap(), // REPLACE
		...
		pow: ProofOfWork {
			...
			nonce: 72, // REPLACE
			proof: Proof {
				nonces: vec![542596, 5343448, 18932353, 27706151, 72715009, 96357555, 109544790, 157351705, 166540480, 168748197, 168930893, 173897309, 179263885, 190575248, 193025917, 194781673, 200881755, 210438979, 220806382, 222006787, 225238331, 226217333, 245428832, 253617060, 258120189, 279272246, 289847363, 301185144, 301830581, 330487205, 360428031, 378580695, 412728484, 426412724, 461745491, 464019212, 482207495, 496350313, 499550182, 509365185, 511762027, 529232573], // REPLACE
				edge_bits: 29,
			},
		},
		..Default::default()
	...
	let kernel = core::TxKernel {
		...
		fee: 0,
		lock_height: 0,
		excess: Commitment::from_vec(util::from_hex("08896647650f8c80d26a162d5a56b3569a4682adccac36ee535207ce3f7845138f".to_string()).unwrap()), // REPLACE
		excess_sig: Signature::from_raw_data(&[243, 9, 174, 143, 108, 199, 220, 224, 112, 128, 199, 150, 163, 35, 13, 154, 145, 119, 216, 162, 228, 20, 52, 223, 199, 50, 148, 154, 111, 239, 234, 225, 213, 155, 50, 12, 252, 58, 220, 97, 140, 212, 243, 34, 152, 51, 249, 1, 17, 201, 243, 121, 5, 78, 78, 84, 69, 143, 236, 161, 171, 229, 46, 235]).unwrap(), // REPLACE
	};
	let output = core::Output {
		features: core::OutputFeatures::Coinbase,
		commit: Commitment::from_vec(util::from_hex("09c284c119540dc9743358f6460b04082a1c9b7fb69bf9e5848043e16466f2a840".to_string()).unwrap()), // REPLACE
		proof: RangeProof {
			plen: SINGLE_BULLET_PROOF_SIZE,
			proof: [242, 196, 160, 82, 202, 174, 45, 227, 41, 149, 41, 201, 166, 128, 168, 181, 60, 190, 121, 182, 239, 166, 237, 196, 78, 206, 90, 196, 93, 180, 237, 22, 153, 166, 58, 242, 3, 227, 100, 79, 242, 245, 29, 177, 204, 130, 39, 56, 88, 227, 3, 185, 249, 239, 61, 80, 218, 65, 169, 237, 23, 112, 151, 120, 11, 123, 172, 242, 26, 169, 222, 32, 33, 54, 173, 88, 4, 54, 188, 2, 129, 191, 19, 147, 120, 56, 24, 121, 42, 20, 9, 60, 33, 121, 126, 156, 42, 139, 71, 224, 167, 31, 212, 180, 131, 177, 85, 12, 63, 237, 81, 13, 241, 228, 145, 224, 166, 70, 147, 212, 246, 93, 46, 56, 0, 252, 54, 160, 136, 183, 125, 129, 126, 223, 50, 138, 40, 81, 104, 54, 111, 154, 94, 249, 111, 187, 110, 65, 24, 31, 111, 42, 229, 240, 183, 124, 81, 