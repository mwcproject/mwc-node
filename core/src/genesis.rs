...
pub fn genesis_floo() -> core::Block {
	let gen = core::Block::with_header(core::BlockHeader {
		...
		pow: ProofOfWork {
			...
			proof: Proof {
				nonces: vec![
					10806478, 24469177, 45705076, 48188811, 50975609, 56233788, 57548634, 63642360,
					76946544, 100198044, 213420727, 220639895, 249404493, 267132137, 268763916,
					300117838, 305796665, 307810803, 309806209, 327282571, 337253995, 349200588,
					366303891, 366379837, 368193464, 393265399, 394555181, 407263159, 439697836,
					444976858, 454109502, 464582623, 476216138, 483446440, 485005225, 488544815,
					492661576, 503848707, 514246675, 521552673, 532743440, 53544157,
				],
				edge_bits: 29,
			},
		},
	...
	let kernel = core::TxKernel {
		...
		excess_sig: Signature::from_raw_data(&[
			139, 32, 222, 174, 157, 206, 51, 16, 131, 74, 45, 103, 55, 152, 86, 49, 136, 19, 148,
			227, 77, 203, 254, 128, 196, 148, 57, 123, 101, 77, 146, 99, 67, 244, 212, 69, 60, 151,
			171, 119, 182, 75, 103, 114, 184, 47, 95, 128, 187, 115, 15, 94, 194, 121, 72, 55, 123,
			231, 13, 37, 169, 116, 39, 188,
		])
		.unwrap(),
	};
