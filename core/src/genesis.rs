...
pub fn genesis_floo() -> core::Block {
	let gen = core::Block::with_header(core::BlockHeader {
		...
		pow: ProofOfWork {
			...
			proof: Proof {
				nonces: vec![
					1541302, 11595158, 16455672, 29235212, 46859837, 52367175, 54227826, 62801582,
					69769728, 92770215, 102852549, 103651213, 107577199, 127215179, 127816885,
					173372704, 177662558, 184779859, 196253685, 206262893, 218162287, 218661130,
					222001356, 245529680, 278342207, 294923722, 312983334, 313067765, 345239293,
					357775495, 359885347, 360074589, 365124339, 384075081, 386947530, 424730835,
					431763165, 433839210, 437951604, 475147228, 517910113, 530380477,
				],
				edge_bits: 29,
			},
		},
	...
	let kernel = core::TxKernel {
		...
		excess_sig: Signature::from_raw_data(&[
			156, 153, 94, 78, 173, 39, 12, 100, 139, 143, 25, 180, 251, 180, 143, 187, 72, 177, 53,
			111, 245, 199, 235, 200, 127, 165, 193, 121, 89, 204, 59, 66, 44, 82, 90, 19, 216, 9,
			163, 128, 198, 246, 48, 10, 207, 7, 239, 80, 23, 135, 142, 63, 193, 127, 180, 226, 219,
			126, 60, 26, 88, 1, 148, 109,
		])
		.unwrap(),
	};
