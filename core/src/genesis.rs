...
pub fn genesis_floo() -> core::Block {
	let gen = core::Block::with_header(core::BlockHeader {
		...
		pow: ProofOfWork {
			...
			proof: Proof {
				nonces: vec![
					903589, 8180848, 9297832, 13554597, 40837487, 58763725, 60905541, 62623421,
					64532420, 66734898, 75920753, 77067784, 81786405, 101333066, 101837004,
					115309097, 120430378, 123784605, 135396791, 165709693, 178590996, 187139502,
					232253389, 241943873, 245533427, 249825880, 265324150, 274087938, 283446854,
					307355479, 325017863, 342787152, 356986186, 379209162, 403022658, 475709684,
					497544736, 505659697, 518019390, 520378421, 523920537, 535050651,
				],
				edge_bits: 29,
			},
		},
	...
	let kernel = core::TxKernel {
		...
		excess_sig: Signature::from_raw_data(&[
			80, 116, 28, 201, 237, 165, 181, 155, 154, 174, 49, 16, 53, 10, 86, 129, 89, 246, 113,
			44, 224, 56, 122, 180, 199, 197, 202, 169, 88, 157, 141, 29, 41, 227, 233, 51, 40, 34,
			195, 101, 162, 5, 227, 10, 213, 146, 110, 238, 74, 189, 105, 63, 225, 67, 70, 242, 137,
			56, 46, 90, 149, 196, 237, 88,
		])
		.unwrap(),
	};
