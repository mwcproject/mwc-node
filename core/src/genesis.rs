...
pub fn genesis_floo() -> core::Block {
	let gen = core::Block::with_header(core::BlockHeader {
		...
		pow: ProofOfWork {
			...
			proof: Proof {
				nonces: vec![
8734864, 13574868, 26540007, 27169350, 33736430, 37924344, 60987328, 63368557, 79104443, 103322499, 171262139, 180269163, 189551451, 196343856, 199899606, 230021695, 239792265, 278488832, 283152686, 287630608, 287836978, 323923763, 333826453, 343449328, 350767271, 352878937, 397098058, 403221015, 405129864, 411546610, 416497675, 421450490, 447445391, 459359377, 466272947, 482533916, 482715670, 501771652, 512347234, 525881993, 529416617, 533589542
				],
				edge_bits: 29,
			},
		},
...
223, 213, 230, 51, 53, 234, 24, 47, 190, 50, 229, 181, 23, 42, 126, 199, 185, 210, 227, 145, 89, 120, 22, 180, 14, 201, 52, 44, 187, 94, 198, 180, 75, 156, 21, 40, 64, 159, 23, 118, 53, 157, 156, 120, 213, 152, 205, 205, 153, 167, 203, 122, 37, 181, 217, 132, 46, 95, 118, 18, 119, 96, 155, 60
		])
		.unwrap(),
	};
