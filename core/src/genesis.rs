...
pub fn genesis_floo() -> core::Block {
	let gen = core::Block::with_header(core::BlockHeader {
		...
		kernel_root: Hash::from_hex(
			"94c23c7006c0bf73d8e96f8c601b0793b983c9c4ca1e8609156366fd303036ea",
		)
		.unwrap(),
		...
		pow: ProofOfWork {
			...
			proof: Proof {
				nonces: vec![
12579587, 18626287, 21782158, 30421444, 38160488, 65789722, 81355052, 89395886, 95489715, 105374685, 134650198, 140014407, 143038950, 163699270, 171377500, 195092730, 206963484, 234137142, 253415959, 257029857, 261623253, 261730625, 296014341, 319470326, 352912916, 357597126, 372135780, 386985260, 391693508, 405243566, 409520308, 430353708, 434474343, 451512836, 458174284, 468888370, 492723796, 502725385, 504625858, 514639753, 521549969, 534356336
				],
				edge_bits: 29,
			},
		},
...
95, 63, 115, 21, 36, 39, 23, 254, 177, 238, 182, 106, 152, 8, 247, 203, 254, 146, 215, 162, 226, 110, 181, 72, 214, 54, 44, 203, 210, 81, 134, 31, 157, 21, 114, 94, 100, 144, 5, 168, 110, 254, 139, 22, 134, 152, 245, 82, 9, 121, 74, 22, 107, 88, 224, 47, 231, 107, 226, 162, 41, 186, 123, 195
		])
		.unwrap(),
	};
