...
pub fn genesis_floo() -> core::Block {
	let gen = core::Block::with_header(core::BlockHeader {
		...
		pow: ProofOfWork {
			...
			proof: Proof {
				nonces: vec![
14838406, 15493587, 25882227, 53616276, 69656051, 118247983, 132212005, 137311630, 138273694, 145819201, 154092703, 166744240, 181460017, 182127358, 196360419, 215215944, 227038887, 233065794, 246362837, 254877152, 262394328, 269146177, 281036295, 283346553, 288326868, 292608879, 297639321, 306088943, 310872575, 353815757, 359328673, 371441535, 398565922, 398771209, 458315865, 458427441, 485691022, 487492072, 506859758, 519922734, 521219970, 534488083
				],
				edge_bits: 29,
			},
		},
...
141, 6, 33, 57, 155, 171, 195, 149, 150, 134, 122, 216, 242, 134, 2, 46, 51, 188, 141, 165, 69, 127, 100, 198, 81, 242, 167, 197, 233, 51, 51, 117, 11, 174, 147, 136, 162, 188, 33, 120, 93, 40, 24, 185, 116, 24, 189, 241, 3, 240, 84, 143, 151, 225, 186, 202, 155, 51, 116, 116, 75, 82, 3, 97
		])
		.unwrap(),
	};
