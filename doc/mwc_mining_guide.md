# Overview #
This page is intended to be the mining guide for MWC. [MWC Miner](https://github.com/mwcproject/mwc-miner) can be used to mine MWC.
MWC miner must be pointed at an [MWC full node](https://github.com/mwcproject/mwc-node). Since MWC is a fork of Grin, grin-miner 
also works for MWC mining. Historically, Grin supported two mining algorithms: C29 (ASIC resistant) and C31+
...
1.) Setup and install a MWC miner: [MWC Miner](https://github.com/mwcproject/mwc-miner). You will need a GPU that has
...
and Nvidia RTX 2080 Ti is a good GPU for mining C31+. Most miners uses C31 ASICs, notably the Ipollo G1 and G1 mini. 
