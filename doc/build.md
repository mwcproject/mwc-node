...
```
If you prefer to use a docker named volume, you can pass `-v .mwc:/root/.mwc` instead.
...
[mwc-miner](https://github.com/mwcproject/mwc-miner). Once your MWC code node is up and running,
